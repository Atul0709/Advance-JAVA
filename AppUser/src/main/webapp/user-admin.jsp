                ...
                <tbody>
                	<c:forEach var="user" items="${listUser}">
	                    <tr>
							...
							<td>
								<a href="edit?id=<c:out value='${user.id}' />" class="settings" title="Settings" data-toggle="tooltip"><i class="material-icons">&#xE8B8;</i></a>
								<a href="#deleteModal" data-tempid="<c:out value='${user.id}' />" class="delete trigger-btn set-userid" title="Delete" data-toggle="modal" ><i class="material-icons">&#xE5C9;</i></a>
							</td>
	                    </tr>
					</c:forEach>
                </tbody>
